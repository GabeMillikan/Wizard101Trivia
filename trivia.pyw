...
QUIZ_ANSWERS = {
    ...
    "State Animals": [
        ...
        ["What is the state mammal of North Carolina?", "Gray Squirrel"],
        ["What is the state animal of New Mexico?", "Black Bear"],
        ["What is the state animal of New York?", "Beaver"],
        ["What is the state wild game animal of Kentucky?", "Gray Squirrel"],
        ["What is the state dog of New Hampshire?", "Chinook"],
